...
const RecentlyAdded = () => {
    ...
    return (
        <div className="">
            <div className="relative flex flex-col items-center justify-center pb-10 bg-gray-100 pt-9 sm:pt-12 lg:pt-16">
                <div className="flex flex-col items-center justify-center px-4 space-y-4 2xl:container 2xl:mx-auto sm:pb-12 lg:pb-0 md:px-6 2xl:px-0">
                    <div className="">
                        <p className="text-lg font-bold leading-9 text-center text-black lg:text-xl">Recently Added</p>
                    </div>
                    <div>
                        <p className="text-base leading-normal text-center text-gray-600 sm:leading-none">Meet our newbies! The latest website templates uploaded to the marketplace.</p>
                    </div>
                </div>
                <h1 className="absolute items-center hidden font-bold text-blue-500 cursor-pointer md:flex right-6 text-end">
                    <span>View More</span>
            ...
            <div className='grid grid-cols-1 gap-6 p-5 bg-gray-100 sm:grid-cols-3 lg:grid-cols-5'>
                {
                    themeCategory.map(item => <div key={item.id}  className={item.id === 1 ? "flex items-center justify-around rounded-lg shadow-xl bg-blue-400  text-white cursor-pointer px-2 py-2" : "flex items-center justify-around rounded-lg shadow-xl bg-white hover:bg-blue-400 text-black hover:text-white cursor-pointer px-2 py-2"}>
                        <img className='w-12 h-12 rounded ' src={item.img} alt="s" />
                        <h1 className='font-semibold '>{item.name}</h1>
                    </div>)
                }
            </div>
            <div className="flex items-center justify-center px-4 mt-10 mb-16 space-y-4 2xl:container 2xl:mx-auto md:px-6 2xl:px-0">
                        ...
                        trending.map(item => <div key={item
                            ...
                            <div className="bg-white rounded-lg shadow-lg ">
                                <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                    ...
                                    <div className="absolute top-0 bottom-0 left-0 right-0 flex justify-end w-full h-full overflow-hidden text-white transition duration-300 ease-in-out bg-fixed rounded-t-lg opacity-0 cursor-pointer hover:opacity-50" style={{ backgroundColor: 'black' }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="z-50 w-10 h-10 mt-5 mr-5 text-white hover:text-red-500">
                                ...
                                <div className="p-6">
                                    <div className="flex items-center mb-5 space-x-4">
                                        ...
                                        <div className="">
                                            <p className="mt-5 text-lg font-semibold leading-5 text-gray-800 ">Magetique - Furniture Magent</p>
                                            <p className="mt-3 text-base font-normal leading-6 text-gray-600  opacity-60">by RockThemes</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between mb-5">
                                        <div>
                                            <div className="flex justify-start mt-2 item-center">
                                    ...
                                    <div className="flex justify-between">
                                        <button className="w-full px-4 py-4 text-base font-medium leading-none text-center text-white bg-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-blue-300">Details</button>
                                        <button className="w-full px-4 py-4 ml-4 text-base font-medium leading-none text-center text-white bg-blue-400 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-gray-600">Live Demo</button>
                                    </div>
                                </div>
                            </div>
                        </div>)
