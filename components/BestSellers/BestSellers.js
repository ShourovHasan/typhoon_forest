...
const BestSeller = () => {
    ...
    return (
        <div className="">
            <div className="relative flex items-center justify-center pb-24 bg-gray-100 pt-9 sm:pt-12 lg:pt-16 sm:pb-52">
                <div className="flex flex-col items-center justify-center px-4 space-y-4 2xl:container 2xl:mx-auto sm:pb-12 lg:pb-0 md:px-6 2xl:px-0">
                    <div className="">
                        <p className="text-lg font-bold leading-9 text-center text-black lg:text-xl">Best Seller Theme</p>
                    </div>
                    <div>
                        <p className="text-base leading-normal text-center text-gray-600 sm:leading-none">Explore Theme that are bought most frequently by people</p>
                    </div>
                </div>
                        ...
                        bestSeller.map(item => <div key={item.seller_id} className="flex justify-center w-full">
                            <div className="bg-white rounded-lg shadow-lg ">
                                <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                    ...
                                    <div className="absolute top-0 bottom-0 left-0 right-0 flex justify-end w-full h-full overflow-hidden text-white transition duration-300 ease-in-out bg-fixed opacity-0 cursor-pointer hover:opacity-50" style={{ backgroundColor: 'black' }}>
                                    ...
                                    <div className="flex items-center justify-between mb-5">
                                        <div>
                                            <div className="flex justify-start mt-2 item-center">
                                                <svg className="w-5 h-5 text-gray-700 text-orange-600 fill-current" viewBox="0 0 24 24">
                                                ...
                                                <svg className="w-5 h-5 text-gray-500 text-orange-600 fill-current" viewBox="0 0 24 24">
                                                    <path d="M12 17.27L18.18 21L16.54 13.97L22 9.24L14.81 8.63L12 2L9.19 8.63L2 9.24L7.46 13.97L5.82 21L12 17.27Z">
                                                    </path>
                                                </svg>
                                                <svg className="w-5 h-5 text-gray-500 text-orange-600 fill-current" viewBox="0 0 24 24">
